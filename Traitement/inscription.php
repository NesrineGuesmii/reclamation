...
if ($mot_de_passe != $conf_mot_de_passe) {
    ...
    header("Location: ../index.php?warning=Les mots de passe ne correspondent pas.");
}
...
if (strlen($mot_de_passe) < 8 ||
    ...
    header("Location: ../index.php?warning=Le mot de passe ne respecte pas les règles de complexité.");
}
